//SPDX-License-Identifier: MIT
    ...
    contract Token is IBEP20, Auth {
        ...
        string constant _name = "Token"; // put everglide or testt name here
        string constant _symbol = "Token"; // put everglide or test symbol here
        ...
        /// @notice Sell Multiplier can bypass Max Fees
        uint256 public constant maxSellMultiplier = 3;
        // max amount that the fees can go to
        ...
        function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
            ...
            } else if (sender != pair && !isFeeExempt[sender] && sellcooldownEnabled){
        ...
        function setCooldownEnabled(bool onoff, bool truefalse) external onlyOwner() {
            buycooldownEnabled = onoff;
            sellcooldownEnabled = truefalse;
        }
