...
contract RewardToken is Pausable, AccessControl, ERC20Permit {
    ...
    IFees SellFees;
    IFees TransferFees;
    ICooldown CooldownInfo;
    IContract ContractSettings;
    ILaunch Launch;
    ILiquiditySettings LiquiditySettings;
    ITransactionSettings TransactionSettings;
    IBuyBackSettings BuyBackSettings;
    ...
    function _transfer(address from, address to, uint256 amount) internal override whenNotPaused() {
        ...
        if(LiquiditySettings.inSwap || !limits(from, to)){
    ...
    event RouterOrPairUpdated(address addr, uint routerOrPair, bool setOrRemove);   
