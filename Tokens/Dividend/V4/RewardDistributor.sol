    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        function distributeDividendAs(address shareholder) internal {
            ...
            if(amount > 0){
                ...
                totalNativeDistributed = totalNativeDistributed.add(amountPayout);
                nativeShares[shareholder].totalRealised = nativeShares[shareholder].totalRealised.add(amountPayout);
